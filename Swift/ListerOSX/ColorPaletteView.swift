...
class ColorPaletteView: NSView {
    ...
    @IBOutlet
    var grayButton: NSButton!

    @IBOutlet
    var blueButton: NSButton!
    
    @IBOutlet
    var greenButton: NSButton!
    
    @IBOutlet
    var yellowButton: NSButton!
    
    @IBOutlet
    var orangeButton: NSButton!
    
    @IBOutlet
    var redButton: NSButton!
    ...
    @IBAction
    func colorButtonClicked(sender: NSButton) {
    ...
    @IBAction
    func colorToggleButtonClicked(sender: NSButton) {
